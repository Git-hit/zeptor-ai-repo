export default function AboutUs() {
    return (
        <div id="about-us" className="flex flex-col justify-center gap-10 max-w-6xl mx-auto my-10 md:my-40">
            <h2 className='text-gray-50 text-2xl md:text-5xl font-medium text-center my-10'>About Us</h2>
            <p className="text-white/70 text-sm md:text-lg text-center px-5 md:px-0">At ZeptorAI, we’re an AI automation experts building smart Pills. Think next-level AI
                ...
                chances. You’re getting fast, clear communication to boost your business.</p>
        </div>
    )
}